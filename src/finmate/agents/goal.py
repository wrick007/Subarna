"""Stage 7 - Goal Planning Agent. Owns prompts.GOAL_AGENT."""

from __future__ import annotations

from ..llm import LLMClient
from ..prompts import GOAL_AGENT
...
def run_goal_agent(
    ...
    return llm_client.call(agent_system_prompt=GOAL_AGENT, user_message=context, response_model=None)
