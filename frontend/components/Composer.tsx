...
export default function Composer({
  ...
  return (
    <div className="border-t border-border bg-paper px-4 py-3 sm:px-8 sm:py-4">
      ...
      <div className="flex items-end gap-2 rounded-2xl border border-border bg-surface p-2 shadow-sm focus-within:border-ledger/40">
        <textarea
          ref={textareaRef}
          rows={1}
          value={value}
        ...
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-ledger text-white transition-opacity enabled:hover:bg-ledger-dark disabled:cursor-not-allowed disabled:opacity-30"
        >
